...
public class Main {
    ...
    private static void initializeTestData(CategoryService categoryService, 
        ...
        Category freelance = categoryService.createCategory("Freelance", "Missions ponctuelles", TransactionType.INCOME);
        Category interets = categoryService.createCategory("Intérêts", "Revenus placements", TransactionType.INCOME);
        
        // Dépenses
        Category alimentation = categoryService.createCategory("Alimentation", "Courses et restaurants", TransactionType.EXPENSE);
        Category logement = categoryService.createCategory("Logement", "Loyer et charges", TransactionType.EXPENSE);
        Category transport = categoryService.createCategory("Transport", "Essence, abonnements", TransactionType.EXPENSE);
